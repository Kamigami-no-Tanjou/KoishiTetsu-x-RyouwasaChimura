...
function Guild:new(object,
    ...
    object.warningCooldownStatus = EUtils.affectBool(warningCooldownStatus or object.warningCooldownStatus or true)
    ...
    object.birthdayAlerts = EUtils.affectBool(birthdayAlerts or object.birthdayAlerts or false)
