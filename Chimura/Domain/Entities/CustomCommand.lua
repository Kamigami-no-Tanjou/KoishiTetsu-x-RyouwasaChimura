...
function CustomCommand:new(object,
    ...
    object.enabled = EUtils.affectBool(enabled or object.enabled) or nil
    object.slashless = EUtils.affectBool(slashless or object.slashless) or nil
    object.triggeredFromContent = EUtils.affectBool(triggeredFromContent or object.triggeredFromContent) or nil
